    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="  overflow-hidden shadow-sm sm:rounded-lg bg-slate-100  rounded-md p-3">
                <div class="   flex  p-2  ">
                    <a href="{{route("admin.roles.index")}}" class = "px-4 my-3 bg-green-500 hover:bg-green-700 font-medium py-2 rounded-md ">Roles Home </a>
                </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="text"
                                           id="title"
                                           value="{{$role->name}}"
                                           name="name" class="block w-full  appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                                </div>
                                @error("name")
