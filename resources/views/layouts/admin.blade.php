        ...
        <div class="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1" x-data="{open:true}" x-show="open">
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p class="text-sm leading-6 text-gray-900">
                    <strong class="font-semibold">{{Session::get("message")}}</strong><svg viewBox="0 0 2 2" class="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true"><circle cx="1" cy="1" r="1" /></svg> </p>
            </div>
            <div class="flex flex-1 justify-end">
                <button type="button" @click="{open = false}" class="-m-3 p-3 focus-visible:outline-offset-[-4px]">
